### Learnings:
- Use Python, BLIP model and gradio to create image caption generation tool

### What is Hugging Face?
- An opensource AI platform
- Pytorch: Deep learning library
- Tensor Flow: Machine learning platform
- Google JAX: Machine learning framework

- Hugging Face helps businesses:
  - add or remove features to improve the efficiency of their models
  - evaluate their generative AI models to filter biased data
  - create multimodal applications with text, image, audio, and video generation capabilities.
 
- BLIP:
  - learns to associate images with relevant text, allowing it to generate captions, answer image-related questions, and support image-based search queries.
